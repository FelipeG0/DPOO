...
public class ConsolaOlimpicos
{
	...
	/**
	 * Le muestra el usuario el país del atleta dado.
	 */
	private void ejecutarPaisdeAtleta()
	{
		...
		try
		{
		String nombre = input("Ingrese el nombre del Atleta para conocer el país que representa: ");
		String pais = calculadora.buscarPaisporAtleta(nombre);
		System.out.println("\n" + pais + " es el país al que " + nombre + " representa.");
		}
